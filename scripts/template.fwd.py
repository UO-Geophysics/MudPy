...
##############ipython#            Green function parameters               #############
coord_type=1 #(=0 for cartesian, =1 for lat/lon (will use Earth flattening transform)
hot_start=118  #Start at a certain subfault number
...
if make_synthetics==1:
    ...
    runslip.make_synthetics(home,project_name,station_file,fault_name,model_name,integrate,static,beta,
