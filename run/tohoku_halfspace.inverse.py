...
Project: Tohoku
Comment: Inversion of Tohoku data with 10s rise times in a halfspace
'''
...
station_file='tohoku.kaldsip_small.sta'    #Station distribution
GF_list='tohoku.kaldisp_small.gflist' #What GFs are to be computed for each station
G_name='halfspace_multivr.g' #Either name of GF matrix to load or name to save GF matrix with
...
rupture_speeds=np.array([1.6,1.8,2.0,2.2,2.4,2.6,2.8])   #In km/s
